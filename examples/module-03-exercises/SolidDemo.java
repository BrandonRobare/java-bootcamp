public class SolidDemo {
    ...
    static double calculateInterest(
        ...
        // DONE: return balance * ratePercent / 100.0 (no System.out here)
    ...
    static void printInterest(double interest) {
        // DONE: printf "Interest earned: %.2f%n"
        System.out.printf("Interest earned: %.2f%n", interest);
    }

    public static void main(String[] args) {
        // DONE: calculate interest for 10_000 at 5%, then print it
        printInterest(calculateInterest(10000, 5));
    }
}
